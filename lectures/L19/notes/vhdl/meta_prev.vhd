...
--    - button_n: Active-low asynchronous push button.
-- Outputs:
--    - reset_s2_n: Stable, synchronized reset signal.
--    - button_edge_s2: Pulse indicating a falling edge on button_n.
--
-- Function:
...
begin
    ...
    --------------------------------------------------------------------------------
    -- Create a process to synchronize the button signal:
    --     - If reset_s2_n_s = '0':
    --         - Set all button synchronizer stages to '1'.
    --     - Else if rising_edge(clock):
    --         - Update the flip-flop stages in sequence.
